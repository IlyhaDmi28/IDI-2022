...
#define LEX_ISTRUE					'y'	// ложный блок
#define LEX_ISFALSE					'n'	// истинный блок
#define LEX_DO						'd'	// do
...
#define LEX_TYPE					'v'	// объ€влени€ переменных
#define LEX_LOGIC_EQUALS			'0'	// проверка на равенство ==
#define LEX_LOGIC_NOT_EQUALS		'1'	// проверка на неравенство !=
#define LEX_LOGIC_MORE_EQ			'2'	// проверка на больше либо равно >=
#define LEX_LOGIC_LESS_EQ			'3'	// проверка на меньше либо равно <=
#define LEX_LOGIC_MORE				'>'	// проверка на больше >
#define LEX_LOGIC_LESS				'<'	// проверка на меньше <
