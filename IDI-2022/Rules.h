#pragma once
#include "GRB.h"
//TS - лексемы, NS - правила. Здесь ниже представлены првила. Они представляют ссобой правильное расположение располаждение лексем в нашей програме. Правила может включать другие правтла
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 19,

		Rule(NS('S'), GRB_ERROR_SERIES, 4,						// Неверная структура программы	
		...
		Rule(NS('Z'), GRB_ERROR_SERIES + 8, 5,								// Ошибка в условии цикла/условного выражения	
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 12, 20,							// Недопустимая синтаксическая конструкция
			...
			Rule::Chain(7, TS('v'), TS('t'), TS('i'), TS('='), NS('V'), TS(';'), NS('K')),	// декларация + присваивание
			Rule::Chain(7, TS('v'), TS('t'), TS('i'), TS('='), NS('W'), TS(';'), NS('K')),	// декларация + присваивание
			Rule::Chain(5, TS('v'), TS('t'), TS('i'), TS(';'), NS('K')),	// декларация
			...
			Rule::Chain(6, TS('v'), TS('t'), TS('i'), TS('='), NS('V'), TS(';')),	// декларация + присваивание
			Rule::Chain(6, TS('v'), TS('t'), TS('i'), TS('='), NS('W'), TS(';')),	// декларация + присваивание
			Rule::Chain(4, TS('i'), TS('='), NS('W'), TS(';')),				// присваивание
			Rule::Chain(4, TS('v'), TS('t'), TS('i'), TS(';')),				// декларация
